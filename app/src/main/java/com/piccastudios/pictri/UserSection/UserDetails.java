...
public class UserDetails {
    ...
    private long signInBadgeNumber = 0;
    ...
    public long getSignInBadgeNumber() {
        return signInBadgeNumber;
    }

    public void setSignInBadgeNumber(long signInBadgeNumber) {
        this.signInBadgeNumber = signInBadgeNumber;
    }
